...
class Command(BaseCommand):
    ...
    def handle_many(self):
        ...
        nags = query.filter(next_nag__lt=now, status="down")
    ...
    def handle_one(self, check):
        ...
        self.stdout.write("alert_after: {} nag_after: {} nag: {} last_nag_alert: {}".format(check.alert_after, check.next_nag, check.nag, check.last_nag))
